"""Headless checks for the placeholder cockpit (ships without a modelled interior).
...
check("the Vanguard has the placeholder cockpit switched on", vanguard.get_editor_property("placeholder_cockpit"))
